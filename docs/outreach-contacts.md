...
## High-Priority Demand Leads (Request Access)
...
| Horseshoe Tavern | Bar/event coord | Bokeelia | Wedding truck needed May 1 | FB DM | MEDIUM |
| Renee Stoll | Event coord, Conservancy of SW FL | Naples | Earth Day (Apr 18) — may be filled | ReneeS@conservancy.org | MONITOR |
| Shadetree Apartments | Property/apt complex | SWFL | In food truck group — venue potential | New member Group 1 | MONITOR |

---

## Supply Leads (Truck Operators to Onboard)

| Name/Truck | Cuisine | Location | Signal | Contact | Priority |
|------------|---------|----------|--------|---------|----------|
| Fork In the Road | American | Fort Myers | Active, marketing May availability | FB DM | HIGH |
| The Corn Dog Lab | American | Fort Myers | Location-alert style poster, active | FB DM | HIGH |
...
| Cholados Raspados Calidosos | Drinks | SWFL | New member Group 1 | FB DM | MEDIUM |
| Simply Greek by WynnberryTruck SRQ | Greek | Sarasota | New member Group 1 | FB DM | MEDIUM |
| Monchis Sweet Treats | Desserts | SWFL | New member Group 1 | FB DM | MEDIUM |
| Sweeter Society | Desserts | SWFL | New member Group 1 | sweetersociety25@yahoo.com | MEDIUM |
| South Florida Gem | TBD | SWFL | New member Group 1 | FB DM | LOW |
| Little Italy in the USA | Pizza/Italian | Ft Myers/Cape Coral | Hiring (growth signal) | FB DM | MEDIUM |
| Jenny Hamilton / Food Truck Fridays | Mixed | SWFL | Recurring weekly event organizer | FB DM | MEDIUM |

---

## Competitor Watch

| Name | Type | Signal | Action |
|------|------|--------|--------|
| Orderup Apps | App company | Joined Group 1 on 2026-04-17 | Monitor — look up what they build |
| Roaming Hunger | National platform | No SWFL focus, no verification, no HOA | Differentiation — use in messaging |

---

## Contact Database Files
Full structured contact data is in:
- `C:\Developer\servicewindow\Market Research\1 - Food Trucks\Food Trucks - Contact Database.docx`
- `C:\Developer\servicewindow\Market Research\2 - Venues\Venues - Contact Database.docx`
- `C:\Developer\servicewindow\Market Research\3 - Truck Requesters\Truck Requesters - Contact Database.docx`
- JSON data: `C:\Developer\servicewindow\Market Research\data\` (food-trucks.json, venues.json, truck-requesters.json, service-providers.json, festivals-events.json)
